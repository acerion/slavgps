...
static void gpx_start(LayerTRW * trw, const char *el, const char **attr)
{
...
static void gpx_end(LayerTRW * trw, const char *el)
{
  ...
  switch ( current_tag ) {
     ...
     case tt_wpt:
       ...
       trw->filein_add_waypoint(c_wp_name, c_wp );
       free( c_wp_name );
       c_wp = NULL;
       c_wp_name = NULL;
       break;
     ...
     case tt_rte:
       ...
       trw->filein_add_track(c_tr_name, c_tr);
       free( c_tr_name );
       c_tr = NULL;
       c_tr_name = NULL;
       break;
