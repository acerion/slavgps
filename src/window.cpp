...
void Window::pan_click(GdkEventButton * event)
{
	/* Set panning origin. */
	this->pan_move_flag = false;
	this->pan_x = (int) event->x;
	this->pan_y = (int) event->y;
}
...
void Window::pan_move(GdkEventMotion * event)
{
	if (this->pan_x != -1) {
...
void Window::pan_release(GdkEventButton * event)
{
	bool do_draw = true;
