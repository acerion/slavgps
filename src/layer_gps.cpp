...
static ParameterSpecification gps_layer_param_specs[] = {
	...
	{ PARAM_GPSD_RETRY_INTERVAL,        "gpsd_retry_interval",       SGVariantType::Duration,     PARAMETER_GROUP_REALTIME_MODE, QObject::tr("Gpsd Retry Interval:"),              WidgetType::Duration,      &gpsd_retry_interval_scale, NULL,                      "" }, // KKAMIL
#endif /* REALTIME_GPS_TRACKING_ENABLED */
