...
namespace SlavGPS {
	...
	private:
		...
		void draw_track_draw_something(const ScreenPos & begin, const ScreenPos & end, QPen & pen, Trackpoint * tp, Trackpoint * tp_next, const Altitude & min_alt, const Altitude & alt_diff);
