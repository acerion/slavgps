...
static Parameter coord_layer_params[] = {
	...
	{ PARAM_LINE_THICKNESS, "line_thickness", SGVariantType::UINT,   PARAMETER_GROUP_GENERIC, N_("Line Thickness:"), WidgetType::SPINBUTTON,     &param_scales[1], line_thickness_default, NULL, NULL },

	{ PARAM_MAX,            NULL,             SGVariantType::PTR,    PARAMETER_GROUP_GENERIC, NULL,                  WidgetType::CHECKBUTTON,    NULL,             NULL,                   NULL, NULL }, /* Guard. */
};
